...
const MapSection = () => {
  ...
  // ✅ Don't render map unless location is available
  if (!userLocation?.lat || !userLocation?.lng) {
    return (
      <div className="mx-auto p-4 text-center text-sm text-gray-500">
          ...
          <div className="animate-bounce">
            ...
            >
              <div className="relative w-[50px] h-[60px]">
                ...
                <div className="animate-pulse absolute top-[7px] left-[50%] -translate-x-1/2 w-[30px] h-[30px] rounded-full overflow-hidden border-2 border-slate-900/20 shadow-md bg-white">
                  {user?.imageUrl ? (
                    <img
                      src={user.imageUrl}
                      alt="User"
